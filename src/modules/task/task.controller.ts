...
export const getMyAssignedTasks = async (req: Request, res: Response) => {
  try {
    ...
    response.response(res, true, StatusCodes.OK, data, "Assigned tasks retrieved successfully");
  } catch (error: any) {
    response.errorResponse(
      res,
      error.status || StatusCodes.INTERNAL_SERVER_ERROR,
...
export const deleteTask = async (req: Request, res: Response) => {
  try {
    ...
    response.response(res, true, StatusCodes.OK, result, "Task deleted successfully");
  } catch (error: any) {
    response.errorResponse(
      res,
      error.status || StatusCodes.INTERNAL_SERVER_ERROR,
